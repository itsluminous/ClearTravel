 ...
 * [trainsAction] for the Trains segment (ADR-024). Built from notification deep links
...
data class JourneysDeepLink(
    ...
    companion object {
        ...
        /** Landing for a finished flights external entry: the Flights segment, detail when saved. */
        fun forFlightsEntry(savedFlightId: String?): JourneysDeepLink =
            JourneysDeepLink(target = DeepLinkContract.TARGET_FLIGHT, entityId = savedFlightId)
    }
}
